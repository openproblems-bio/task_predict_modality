...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_predict_modality/task_predict_modality/src/methods/babel/babel/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/methods/babel",
    "viash_version" : "0.9.7",
...
include { babel_train } from "${meta.resources_dir}/../../../nextflow/methods/babel_train/main.nf"
include { babel_predict } from "${meta.resources_dir}/../../../nextflow/methods/babel_predict/main.nf"
