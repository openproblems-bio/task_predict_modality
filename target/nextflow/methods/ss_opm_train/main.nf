...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Epochs before the training-length ratio starts ramping up (the authors' setting). Must be\nbelow `--n_epochs`, otherwise every epoch stays at ratio 0.\n",
          "info" : {
            "test_default" : 0
          },
          "default" : [
        ...
        },
        {
          ...
          "description" : "HGNC complete set (tab separated), used to name the genes and proteins when building the CITE\ninput gene masks. Downloaded into the image when not given.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
          "direction" : "input",
        ...
        },
        {
          ...
          "description" : "Reactome gene sets (GMT), used to build the CITE input gene masks. Downloaded into the image\nwhen not given.\n",
          "must_exist" : true,
          "create_parent" : true,
          "required" : false,
          "direction" : "input",
        ...
        },
        {
          ...
          "description" : "Number of training cells used to fit the global affine map from the model's per-cell z-scored\noutput to the target scale.\n",
          "default" : [
            5000
          ],
          "required" : false,
      ...
      "setup" : [
        {
          "type" : "docker",
          "run" : [
            "pip install --no-cache-dir --no-deps git+https://github.com/shu65/open-problems-multimodal.git"
          ]
        },
        {
          "type" : "python",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_predict_modality/task_predict_modality/src/methods/ss_opm/ss_opm_train/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
    "output" : "target/nextflow/methods/ss_opm_train",
    "viash_version" : "0.9.7",
...
par = {
  ...
  'burnin_length_epoch': $( if [ ! -z ${VIASH_PAR_BURNIN_LENGTH_EPOCH+x} ]; then echo "int(r'${VIASH_PAR_BURNIN_LENGTH_EPOCH//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'day_pattern': $( if [ ! -z ${VIASH_PAR_DAY_PATTERN+x} ]; then echo "r'${VIASH_PAR_DAY_PATTERN//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'donor_pattern': $( if [ ! -z ${VIASH_PAR_DONOR_PATTERN+x} ]; then echo "r'${VIASH_PAR_DONOR_PATTERN//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'hgnc_complete_set': $( if [ ! -z ${VIASH_PAR_HGNC_COMPLETE_SET+x} ]; then echo "r'${VIASH_PAR_HGNC_COMPLETE_SET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'reactome_pathways': $( if [ ! -z ${VIASH_PAR_REACTOME_PATHWAYS+x} ]; then echo "r'${VIASH_PAR_REACTOME_PATHWAYS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'n_rescaling_cells': $( if [ ! -z ${VIASH_PAR_N_RESCALING_CELLS+x} ]; then echo "int(r'${VIASH_PAR_N_RESCALING_CELLS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_predict_modality/methods/ss_opm_train",
    "tag" : "build_main"
  },
  "label" : [
    "veryhighmem",
