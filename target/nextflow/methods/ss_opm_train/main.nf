  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "Epochs before the training-length ratio starts ramping up. Must be below\n`--n_epochs`, otherwise every epoch stays at ratio 0.\n",
          "info" : {
            "test_default" : 0
          },
          "default" : [
...
par = {
  ...
  'cell_type_col': $( if [ ! -z ${VIASH_PAR_CELL_TYPE_COL+x} ]; then echo "r'${VIASH_PAR_CELL_TYPE_COL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
