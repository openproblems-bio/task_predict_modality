...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_predict_modality/task_predict_modality/src/methods/cellmapper_linear/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'fallback_representation': $( if [ ! -z ${VIASH_PAR_FALLBACK_REPRESENTATION+x} ]; then echo "r'${VIASH_PAR_FALLBACK_REPRESENTATION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'mask_var': $( if [ ! -z ${VIASH_PAR_MASK_VAR+x} ]; then echo "r'${VIASH_PAR_MASK_VAR//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_predict_modality/methods/cellmapper_linear",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
