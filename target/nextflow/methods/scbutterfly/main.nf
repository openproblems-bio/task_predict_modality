...
meta = [
  ...
  "dependencies" : [
    {
      "name" : "methods/scbutterfly_train",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "methods/scbutterfly_predict",
      "repository" : {
        "type" : "local"
      }
    }
  ...
  "links" : {
    "repository" : "https://github.com/BioX-NKU/scButterfly",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_predict_modality/task_predict_modality/src/methods/scbutterfly/scbutterfly/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { scbutterfly_train } from "${meta.resources_dir}/../../../nextflow/methods/scbutterfly_train/main.nf"
include { scbutterfly_predict } from "${meta.resources_dir}/../../../nextflow/methods/scbutterfly_predict/main.nf"
