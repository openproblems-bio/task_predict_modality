...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_predict_modality/task_predict_modality/src/methods/babel/babel_train/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'hidden_dim': $( if [ ! -z ${VIASH_PAR_HIDDEN_DIM+x} ]; then echo "int(r'${VIASH_PAR_HIDDEN_DIM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  ...
  'loss2_weight': $( if [ ! -z ${VIASH_PAR_LOSS2_WEIGHT+x} ]; then echo "float(r'${VIASH_PAR_LOSS2_WEIGHT//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_predict_modality/methods/babel_train",
    "tag" : "build_main"
  },
  "label" : [
    "highmem",
