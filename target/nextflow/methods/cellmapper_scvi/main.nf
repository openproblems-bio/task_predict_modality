...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_predict_modality/task_predict_modality/src/methods/cellmapper_scvi/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'kernel_method': $( if [ ! -z ${VIASH_PAR_KERNEL_METHOD+x} ]; then echo "r'${VIASH_PAR_KERNEL_METHOD//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'n_neighbors': $( if [ ! -z ${VIASH_PAR_N_NEIGHBORS+x} ]; then echo "int(r'${VIASH_PAR_N_NEIGHBORS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'use_hvg': $( if [ ! -z ${VIASH_PAR_USE_HVG+x} ]; then echo "r'${VIASH_PAR_USE_HVG//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'adt_normalization': $( if [ ! -z ${VIASH_PAR_ADT_NORMALIZATION+x} ]; then echo "r'${VIASH_PAR_ADT_NORMALIZATION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'plot_umap': $( if [ ! -z ${VIASH_PAR_PLOT_UMAP+x} ]; then echo "r'${VIASH_PAR_PLOT_UMAP//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_predict_modality/methods/cellmapper_scvi",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
